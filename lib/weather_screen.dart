...
import 'package:weather_app/secrets.dart' show OpenWeatherAPIKey;
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          final currentTemp = curentWeatherData['main']['temp'];
          final currentSky = curentWeatherData['weather'][0]['main'];

          final currentPressure = curentWeatherData['main']['pressure'];

          final currentWindSpeed = curentWeatherData['wind']['speed'];

          final currentHumidity = curentWeatherData['main']['humidity'];
